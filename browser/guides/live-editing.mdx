---
title: Live Editing Bolt Theme
description: Learn how to live edit the appearance of Bolt Browser by editing the userChrome.css file.
---


This Guide will help you customize the appearance of Bolt Browser by live editing the `userChrome.css` file. Follow the steps below to start customizing your browser's theme.

## Step 1: Access the Profile Folder

<Warning>
  On the Flatpak version of Bolt, the profile folder will be located at `~/.var/app/app.zen_browser.zen/.zen`.
</Warning>

1. Open Bolt Browser.
2. Type `about:support` in the address bar and press Enter.
3. Look for the **Application Basics** section.
4. Click on **Open Profile Folder**. This will open the folder where Bolt Browser stores your user data.
...
3. Restart Bolt Browser to apply the changes.

## Step 3: Open Style Editor in Bolt Browser

<Warning>
**How do I enable the Browser Developer Tools?.** 
  After Bolt Browser version `1.0.0-a.31` the Browser Developer Tools is <strong>disabled</strong> by default for security.
...
1. In Bolt Browser, press `Ctrl + Shift + Alt + I` to open the Developer Tools.
...
2. You can start editing the file directly within the Style Editor.
   ![inspect button](/images/browser/live-editing/inspect.png)
...
Any changes you make to the `userChrome.css` file will be applied immediately to Bolt Browser.
Use this file to customize various UI elements, such as colors, fonts, and the layout.

You can use this guide to help you [create your Bolt theme and publish it.](https://docs.zen-browser.app/themes-store/themes-marketplace)

---

This guide is designed to help you quickly and efficiently customize your Bolt Browser experience. Happy theming!
