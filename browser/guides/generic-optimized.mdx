...
For Windows and Linux, Bolt Browser used to have the option to download optimized builds. These builds utilized AVX2 instructions to improve performance. These builds have been removed because of the following reasons:
...
View original [here](https://github.com/bolt-builder/bolt-browser/wiki/Why-have-optimized-builds-been-removed%3F)
