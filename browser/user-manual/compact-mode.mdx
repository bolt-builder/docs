...
Compact Mode is one of Bolt's main features. It lets you hide all browser toolbars and gives a wider view of the website you're currently visiting.

You can activate this feature by right-click on an empty area on the `toolbar > "Compact Mode" > "Enable compact mode"`, or use `Ctrl + S` keyboard shortcut.
...
![Compact Mode](/images/browser/user-manual/compact-mode/enable-compact-mode.png)
...
- **Toggle Floating Sidebar**: `Alt + Ctrl + S` - Shows the tab sidebar for all toolbar modes
- **Toggle Floating Toolbar**: `Alt + Ctrl + W` - Shows the top toolbar for Multiple & Collapsed Toolbar mode
