...
![Translation Panel Popped Up](/images/browser/user-manual/translations/translate-panel.png)
...
Bolt detects the page languages manually and will suggest to translate it to your preferred languages. You can use the "**Translate from**" dropdown menu to change page language to detect, and use the "**Translate to**" dropdown menu to change your translation output language. Select "**Translate**" to translate the entire page.

<Note>
Bolt will download the language first if you're using this feature for the first time. After the language is downloaded, translation process will take around 20-60 seconds, depend on the length of contents.
</Note>
...
![Translate original](/images/browser/user-manual/translations/translate-original.png)
...
![Translate selected](/images/browser/user-manual/translations/translate-selected.png)
...
![Translate selection](/images/browser/user-manual/translations/translate-selection.png)
...
![Translate link text](/images/browser/user-manual/translations/translate-link-text.png)
...
![Translate options](/images/browser/user-manual/translations/translate-options.png)
...
Bolt lets you set separate languages for displaying user interface (menu, messages, notifications) and webpages, accessible from `Settings` > `General` > `Language & Appearance` > `Language`. 

Select "**Choose**" beside the "Choose your preferred language for displaying pages" text to open the Webpage Language Settings.

![Webpage Language Settings](/images/browser/user-manual/translations/webpage-language-settings.png)
...
![More Translation Options](/images/browser/user-manual/translations/more-translation-options.png)

### Supported Languages

Here are the languages that currently supported for translating webpages in Bolt:
- Arabic
- Bulgarian
- Chinese (Simplified)
- Catalan
