...
Different from most browsers, Bolt uses the **URL bar** as a quick and efficient way to navigate the web, eliminating the need for a dedicated new tab page. 
...
When you click the **New Tab** button in Bolt, the URL bar will pop up on top of your current tab. Simply type your URL or search query into the bar, and hit Enter to search keywords or visit sites directly in a new tab. 
...
Bolt has several floating behaviors for its URL bar, which can be changed in `Settings` > `Look and Feel` > `Bolt URL Bar`:
...
By default, Bolt provides **Google**, **DuckDuckGo**, and **Wikipedia** (English) as default search engine providers. You can choose between Google, DuckDuckGo and *[Ecosia*](https://blog.ecosia.org/ecosia-firefox-switch/)* in the onboarding process after installing Bolt. 

![Default search engines during onboarding](/images/browser/user-manual/urlbar/onboarding-search.png)
...
![Add new search engine](/images/browser/user-manual/urlbar/add-new-service.png)
...
![Search Shortcuts Menu](/images/browser/user-manual/urlbar/search-shortcuts.png)
...
![Add Custom Search Engine](/images/browser/user-manual/urlbar/add-manual.png)
