...
Bolt's Split View lets you view up to 4 tabs side by side, so you can compare information or multitask easily.

![Split View](/images/browser/user-manual/split-view/split-view.png)
...
*/}
![Split ](/images/browser/user-manual/split-view/split-context-menu.png)
...
- Currently, you can **unsplit all tabs within a split view** by pressing `Alt + Ctrl + U` shortcut.

### Toggle Split View shortcuts

Bolt also provides keyboard shortcuts to help you rearrange the split tabs automatically into a horizontal, vertical, or grid layout.
