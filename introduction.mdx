---
title: "Introduction to Bolt: the open-source terminal AI agent"
sidebarTitle: "Introduction"
description: "Meet Bolt: an open-source terminal AI coding agent with ten agents, durable sessions, project memory, MCP, 75+ LLM providers, TUI, and desktop app."
