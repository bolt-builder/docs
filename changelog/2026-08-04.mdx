...
description: "Weekly Bolt changelog: right-to-left layout support, Poolside provider, 11 new UI languages, locale-aware pluralization, richer Markdown, and workspace fixes."
---

## New features

- **Right-to-left layout support** — Arabic, Urdu, and Punjabi now render with mirrored navigation, controls, icons, tabs, drawers, and text handling throughout the desktop app, so RTL users get a native reading direction end to end. Switch languages in **Settings → Appearance → Language**. See [Desktop features](/desktop/features).
