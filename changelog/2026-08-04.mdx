...
description: "Weekly Bolt changelog: GPT-5 reasoning effort scoped to supported variants, diff annotation polish, and TUI reasoning header spinner restored."
---
