...
sidebarTitle: "Skills"
description: "Skills are named, reusable playbooks the agent can invoke through the skill tool — handy for canned workflows like 'ship a release' or 'run the full lint suite'."
---
