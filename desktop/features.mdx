...
description: "Everything the Bolt desktop app adds on top of the CLI — multi-window sessions, prompt composer, integrated terminal, command palette, native notifications, and 17 UI languages."
---
