...
description: "Install the Bolt desktop app for multi-window sessions, an integrated terminal, prompt composer with image paste, auto-updates, and 28 UI languages."
url: "desktop/install"
---
...
Bolt's interface is localised into 28 languages. Change the display language in **Settings → Appearance → Language**.
